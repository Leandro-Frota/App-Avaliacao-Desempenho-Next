...
export const updateDataRegisterEmployee = async (employeeId, data) =>
  api.patch(`/employees/${employeeId}`, data);

export const saveStepData = async (employeeId, step, data) =>
  api.put(`/employees/${employeeId}/steps/${step}`, data);

export const getStepData = async (employeeId, step) =>
  api.get(`/employees/${employeeId}/step/${step}`);
